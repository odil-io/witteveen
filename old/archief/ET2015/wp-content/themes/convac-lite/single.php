			...
			<div class="row-fluid">
				<div id="container" class="span8">
					<div id="content">  
							<div class="post" id="post-<?php the_ID(); ?>">
								...
								<div class="convac-post-box clearfix">
									...
									<div class="featured-image-shadow-box">
										...
										<?php the_post_thumbnail('convac_lite_standard_img'); ?>
										</a>
									</div>
								...
								<div class="conv-category"><?php if (has_category()) { ?><span class="category"><i class="fa fa-folder">&nbsp;</i> <?php the_category(','); ?></span><?php } ?></div>

								<div class="skepost clearfix">
									<?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'convac-lite' ) ); ?>
									<?php wp_link_pages( array('before' => '<p><strong>'.__('Pages :','convac-lite').'</strong>','after' => '</p>', __('number','convac-lite') ) ); ?>
								</div>
								<!-- skepost -->
						...
						<div class="post">
							<h2><?php esc_html_e('Post Does Not Exist','convac-lite'); ?></h2>
						</div>
						<?php endif; ?>
					</div><!-- content --> 
				</div><!-- container --> 
