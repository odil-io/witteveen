	...
	<div class="container">
		<div class="row-fluid">
			<div class="container_inner clearfix">
				<h1 class="title"><?php esc_html_e('404','convac-lite'); ?></h1>
				...
				<div class="post">
					<div class="skepost _404-page">
						<div class="_404_artbg">
							<?php esc_html_e('Error 404','convac-lite'); ?>
						</div>
						<?php get_search_form(); ?></br></br>
						<?php esc_html_e('Sorry, but the requested resource was not found on this site. Please try again or contact the administrator for assistance.','convac-lite'); ?>
					</div>
					<!-- post --> 
				</div>
				<!-- post -->
